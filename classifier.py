...
class LlamaEmbeddingClassifier(torch.nn.Module):
	...
	def forward(self, input_ids):
		...
		# Find the hidden state of the final token of each sequence
		...
		# Assuming padding token is 0 (you may need to adjust this based on your tokenizer)
		last_token_indices = (input_ids != 0).sum(dim=1) - 1  # -1 because of 0-indexing
